...
<body class="text-center" style="background-image: url(images/doctor1.jpg); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        <header class="masthead mb-auto">
            <div class="inner">
                <!-- Add logo here -->
                <h3 class="masthead-brand">MediTrack</h3>
        ...
        <main role="main" class="inner cover">
            <h1 class="cover-heading">MediTrack</h1>
            <p class="lead">Keep track of any medication. Get notified of scheduled prescriptions. Plan a meeting with a doctor and get help with prescriptions too!</p>
        </main>

        <footer class="mastfoot mt-auto">
            <div class="inner">
                <p>Dennis Onyango x Jane Mwangi</p>
            </div>
        </footer>
    </div>
